    ...
    <div ref={containerRef} className="relative w-full max-w-sm">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full pl-9 pr-8 py-2 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 focus:border-transparent transition-all"
        />
        {query && (
          <button
            onClick={() => {
            ...
            <>
              <div className="py-2">
                {results.map((product) => (
                  ...
                  >
                    {/* Imagen */}
                    <div className="relative w-10 h-10 bg-green-50 dark:bg-gray-800 rounded-lg flex items-center justify-center shrink-0 overflow-hidden">
                      {product.images?.[0] ? (
                        <Image
