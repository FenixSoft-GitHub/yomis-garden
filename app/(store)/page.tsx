...
//     <div>
//       {/* Hero */}
//       <section className="relative bg-linear-to-br from-green-50 dark:from-green-950 via-emerald-50 to-teal-600 px-4 h-screen flex items-center">
...
//               <Leaf className="size-6 text-green-600 dark:text-green-400" />
//             </div>
//             <h3 className="font-semibold text-gray-900 dark:text-gray-300">Plantas saludables</h3>
//             <p className="text-sm text-gray-500 dark:text-gray-400">
//               Cultivadas y seleccionadas directamente en nuestro vivero con los
//               más altos estándares.
//             </p>
...
//               <Truck className="size-6 text-green-600 dark:text-green-400" />
//             </div>
//             <h3 className="font-semibold text-gray-900 dark:text-gray-300">Envío seguro</h3>
//             <p className="text-sm text-gray-500 dark:text-gray-400">
//               Empaque especial para plantas vivas. Envíos locales y nacionales
//               de accesorios.
//             </p>
...
//               <Shield className="size-6 text-green-600 dark:text-green-400" />
//             </div>
//             <h3 className="font-semibold text-gray-900 dark:text-gray-300">Garantía de calidad</h3>
//             <p className="text-sm text-gray-500 dark:text-gray-400">
//               Si tu planta llega en mal estado, la reponemos. Tu satisfacción es
//               nuestra prioridad.
//             </p>
